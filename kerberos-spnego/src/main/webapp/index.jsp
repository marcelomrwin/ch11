...
<ul>
	...
	<li><a href="<c:url value='/user/'/>">User page</a> - only users with User role can access it</li>
...
<a href="<c:url value='/user/SessionStatusCheckServlet'/>">requires User role</a> 
